...
//#include "Shadow/HelloWorldScene.h"
...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("TestAndLearn", cocos2d::Rect(0, 0, designResolutionSize.width * 0.6f, designResolutionSize.height * 0.6f));
#else
        glview = GLViewImpl::create("TestAndLearn");
#endif
	...
	*/
	...
	//auto scene = FourTreeScene::create();
	//auto scene = HelloWorld::createScene();
	//auto scene = OBBScene::create();
	//auto scene = BarrageScene::create();
	//auto scene = GameScene::create();
	//auto scene = LeetCodeTest::create();
	//auto scene = LearnScene_2::create();
	auto scene = LearnScene_3::create();
	//auto scene = HelloWorld::createScene();
    // run
	/*
